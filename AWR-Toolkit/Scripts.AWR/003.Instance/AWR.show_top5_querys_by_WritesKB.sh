#!/bin/ksh
# #####################################################################
# $Header: AWR.show_top5_querys_by_WritesKB.sh 30/03/2011 sduprat_es Exp $
#
# AWR.show_top5_querys_by_WritesKB.sh
#
...
#
#    USAGE
#     AWR.show_top5_querys_by_WritesKB.sh <AWR SNAPSHOT> <INSTANCE_NUMBER>
#     AWR.show_top5_querys_by_WritesKB.sh -show => lists the available snapshots in the database !!!
#
#    DESCRIPTION
...
select V.* , V.TotalMetricKB/V.TotalExec as KBWritesPerExec 
from (
...
sum(BEGSTAT.PHYSICAL_WRITE_BYTES_DELTA)/1024 as TotalMetricKB,
