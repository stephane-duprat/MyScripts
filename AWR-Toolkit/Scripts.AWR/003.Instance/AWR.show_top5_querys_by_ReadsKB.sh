#!/bin/ksh
# #####################################################################
# $Header: AWR.show_top5_querys_by_ReadsKB.sh 30/03/2011 sduprat_es Exp $
#
# AWR.show_top5_querys_by_ReadsKB.sh
#
...
#
#    USAGE
#     AWR.show_top5_querys_by_ReadsKB.sh <AWR SNAPSHOT> <INSTANCE_NUMBER>
#     AWR.show_top5_querys_by_ReadsKB.sh -show => lists the available snapshots in the database !!!
#
#    DESCRIPTION
...
select V.* , V.TotalMetricKB/V.TotalExec as KBReadsPerExec 
from (
...
sum(BEGSTAT.PHYSICAL_READ_BYTES_DELTA)/1024 as TotalMetricKB,
