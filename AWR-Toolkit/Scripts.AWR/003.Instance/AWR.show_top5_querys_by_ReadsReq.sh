#!/bin/ksh
# #####################################################################
# $Header: AWR.show_top5_querys_by_ReadsReq.sh 30/03/2011 sduprat_es Exp $
#
# AWR.show_top5_querys_by_ReadsReq.sh
#
...
#
#    USAGE
#     AWR.show_top5_querys_by_ReadsReq.sh <AWR SNAPSHOT> <INSTANCE_NUMBER>
#     AWR.show_top5_querys_by_ReadsReq.sh -show => lists the available snapshots in the database !!!
#
#    DESCRIPTION
