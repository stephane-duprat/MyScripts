#!/bin/ksh
# #####################################################################
# $Header: AWR.show_top5_querys_by_Gets.sh 30/03/2011 sduprat_es Exp $
#
# AWR.show_top5_querys_by_Gets.sh
#
...
#
#    USAGE
#     AWR.show_top5_querys_by_Gets.sh <AWR SNAPSHOT> <INSTANCE_NUMBER>
#     AWR.show_top5_querys_by_Gets.sh -show => lists the available snapshots in the database !!!
#
#    DESCRIPTION
