#!/bin/ksh
# #####################################################################
# $Header: AWR.show_top5_querys_by_Gets_by_PlanHash.sh 30/03/2011 sduprat_es Exp $
#
# AWR.show_top5_querys_by_Gets_by_PlanHash.sh
#
...
#
#    USAGE
#     AWR.show_top5_querys_by_Gets_by_PlanHash.sh <AWR SNAPSHOT> <INSTANCE_NUMBER>
#     AWR.show_top5_querys_by_Gets_by_PlanHash.sh -show => lists the available snapshots in the database !!!
#
#    DESCRIPTION
...
set linesize 500
col "Begin Snap=$bsnap - Instance=$inst_num" format a60
...
sum(BEGSTAT.BUFFER_GETS_DELTA) as TotalMetric,
