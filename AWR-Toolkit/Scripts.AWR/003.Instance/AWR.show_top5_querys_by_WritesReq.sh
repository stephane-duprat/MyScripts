#!/bin/ksh
# #####################################################################
# $Header: AWR.show_top5_querys_by_WritesReq.sh 30/03/2011 sduprat_es Exp $
#
# AWR.show_top5_querys_by_WritesReq.sh
#
...
#
#    USAGE
#     AWR.show_top5_querys_by_WritesReq.sh <AWR SNAPSHOT> <INSTANCE_NUMBER>
#     AWR.show_top5_querys_by_WritesReq.sh -show => lists the available snapshots in the database !!!
#
#    DESCRIPTION
...
select V.* , V.TotalMetricReq/V.TotalExec as WritesReqPerExec 
from (
...
sum(BEGSTAT.PHYSICAL_WRITE_REQUESTS_DELTA) as TotalMetricReq,
